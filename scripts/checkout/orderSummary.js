                ...
                <div class="cart-item-details">
                    ...
                    <div class="product-quantity js-product-quantity-${matchingProduct.id}">
                        <span>
                            ...
                            <input class="quantity-input js-quantity-input js-quantity-input-${matchingProduct.id}" data-product-id="${matchingProduct.id}" type="number" value="${cartItem.quantity}">
                        </span>
